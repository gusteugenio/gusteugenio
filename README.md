## Olá! Me chamo Gustavo e sou desenvolvedor fullstack 💻

💼 Desenvolvedor Fullstack Júnior com quase 3 anos de experiência em sistemas web e mobile.
🎓 Estudante de Engenharia de Software na UTFPR.  
🚀 Atuação em todo o ciclo de desenvolvimento, com foco em qualidade, integrações e boas práticas.

Tenho experiência com **Laravel, ASP.NET (MVC + Entity Framework), C#, Angular, PHP, TypeScript/JavaScript, MySQL, SQL Server e Docker**.

Trabalho com desenvolvimento de sistemas corporativos, APIs REST, integrações entre sistemas e aplicações mobile com Ionic.
